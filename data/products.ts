...
export const products: Product[] = [
  {
    ...
    description: "Handcrafted Grade 1 English Willow cricket bat with massive edges and exquisite balance. Perfect for professional play and tournament matches.",
    price: 12500,
    originalPrice: 15000,
    category: "Cricket Bats",
    image: "https://picsum.photos/seed/bat1/600/600",
    images: [
      "https://picsum.photos/seed/bat1/600/600",
      "https://picsum.photos/seed/bat1-side/600/600",
      "https://picsum.photos/seed/bat1-handle/600/600"
    ],
    itemNumber: "No. 07",
    inStock: true,
    isBestSeller: true,
  ...
  },
  {
    ...
    description: "Durable Kashmir willow bat ideal for net practice and hard tennis ball cricket. Great value for money with a thick profile and comfortable grip.",
    price: 1899,
    originalPrice: 2499,
    category: "Cricket Bats",
    image: "https://picsum.photos/seed/bat2/600/600",
    images: [
      "https://picsum.photos/seed/bat2/600/600",
      "https://picsum.photos/seed/bat2-back/600/600",
      "https://picsum.photos/seed/bat2-grain/600/600"
    ],
    itemNumber: "No. 18",
    inStock: true,
    isTrending: true,
  },
  {
    ...
    images: [
      "https://picsum.photos/seed/bat3/600/600",
      "https://picsum.photos/seed/bat3-toe/600/600",
      "https://picsum.photos/seed/bat3-sweet/600/600"
    ],
    itemNumber: "No. 10",
    inStock: true,
    isBestSeller: true,
  },
  {
    ...
    description: "Lightweight, high-density foam batting pads offering maximum protection and mobility at the crease with adjustable straps.",
    price: 2200,
    category: "Cricket Gear",
    image: "https://picsum.photos/seed/pad1/600/600",
    images: [
      "https://picsum.photos/seed/pad1/600/600",
      "https://picsum.photos/seed/pad1-back/600/600",
      "https://picsum.photos/seed/pad1-side/600/600"
    ],
    itemNumber: "No. 01",
    inStock: true,
    isBestSeller: true,
  ...
  },
  {
    ...
    description: "Sheep leather palm batting gloves with sausage finger design for ultimate protection, ventilation, and sweat absorption.",
    price: 1250,
    category: "Cricket Gear",
    image: "https://picsum.photos/seed/glove1/600/600",
    images: [
      "https://picsum.photos/seed/glove1/600/600",
      "https://picsum.photos/seed/glove1-palm/600/600"
    ],
    itemNumber: "No. 04",
    inStock: true,
  },
  {
    ...
    images: [
      "https://picsum.photos/seed/helmet1/600/600",
      "https://picsum.photos/seed/helmet1-side/600/600"
    ],
    itemNumber: "No. 12",
    inStock: true,
    isTrending: true,
  },
  {
    ...
    description: "Fully customizable team jersey with breathable, moisture-wicking fabric. Add your custom team logo, player name, and jersey number.",
    price: 899,
    category: "Custom Jerseys",
    image: "https://picsum.photos/seed/jersey1/600/600",
    images: [
      "https://picsum.photos/seed/jersey1/600/600",
      "https://picsum.photos/seed/jersey1-back/600/600",
      "https://picsum.photos/seed/jersey1-detail/600/600"
    ],
    itemNumber: "No. 45",
    inStock: true,
    isBestSeller: true,
  ...
  },
  {
    ...
    images: [
      "https://picsum.photos/seed/whites1/600/600",
      "https://picsum.photos/seed/whites1-pants/600/600"
    ],
    itemNumber: "No. 03",
    inStock: true,
  },
  {
    ...
    images: [
      "https://picsum.photos/seed/socks1/600/600"
    ],
    itemNumber: "No. 99",
    inStock: true,
    isBestSeller: true,
  },
  {
    ...
    images: [
      ...
      "https://picsum.photos/seed/bag1-inside/600/600"
    ],
    itemNumber: "No. 77",
    inStock: true,
  },
  {
    ...
    images: [
      "https://picsum.photos/seed/grip1/600/600"
    ],
    itemNumber: "No. 11",
    inStock: true,
  }
